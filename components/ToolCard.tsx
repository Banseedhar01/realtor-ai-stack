...
export default function ToolCard({ tool }: ToolCardProps) {
  ...
  return (
    <article className="card-glow relative flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200/90 bg-white/95 p-6 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_22px_45px_rgba(30,64,175,0.16)]">
      ...
      <h4 className="relative mt-4 flex items-center gap-1.5 text-xs font-bold uppercase tracking-wide text-slate-900">
        <span className="h-3 w-0.5 rounded-full bg-accent-500" aria-hidden="true" />
        Key Features
      </h4>
      ...
      <div className="relative mt-4 overflow-hidden rounded-lg border border-primary-100 bg-gradient-to-r from-primary-50 to-white px-3 py-2.5">
        <span className="mr-1.5 text-xs font-bold uppercase tracking-[0.12em] text-primary-600">Pricing</span>
      ...
      <div className="relative mt-auto flex gap-3 pt-5">
        <a
          ...
          className="inline-flex flex-1 items-center justify-center rounded-lg bg-gradient-to-r from-primary-500 to-primary-600 px-4 py-2.5 text-sm font-bold text-white shadow-sm transition-all duration-200 hover:-translate-y-px hover:from-primary-600 hover:to-primary-700 hover:shadow-glow"
        >
          Try Tool →
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer nofollow sponsored"
          className="inline-flex items-center justify-center rounded-lg border border-slate-200 bg-transparent px-4 py-2.5 text-sm font-medium text-slate-500 transition-all duration-200 hover:border-primary-300 hover:text-primary-600"
        >
          View Pricing
        </a>
      </div>
